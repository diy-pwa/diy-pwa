...
require_once __DIR__ . "/sqlite-database-integration/load.php";`);
            const sDB = (await this.fs.promises.readFile("wordpress/wp-content/mu-plugins/sqlite-database-integration/db.copy")).toString();
            await this.fs.promises.writeFile("wordpress/wp-content/db.php", sDB.replace('/plugins/sqlite-database-integration', '/mu-plugins/sqlite-database-integration'));    
